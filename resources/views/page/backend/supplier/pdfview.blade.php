...
<div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Supplier - Print Area View</h4>
            </div>
            <div style="display: flex;">
                <button onclick="printDiv('supplierprintableArea')" class="btn btn-success me-2"><i class="fa fa-print"></i>
                    Print</button>
            </div>
        </div>
            ...
            <div id="supplierprintableArea" >
                <div >
                     ...
                     <div class="row" >
                        <div class="logoname">
                           <div>
                                 <h4  style="text-transform: uppercase; color:green;text-align:center;">Supplier Balance Report</h4>
                           </div>
                        </div>
                        ...
                        <table  class="table border"  id="customers" style="margin-top:10px;">
                           <thead class="border" style="background: #eee;  ">
                                 <tr>
                                    ...
                                    <th class="border" style="color:black;">Supplier</th>
